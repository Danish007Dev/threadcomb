...
/**
 * @type {React.ForwardRefExoticComponent<React.ButtonHTMLAttributes<HTMLButtonElement> & { variant?: string, size?: string, asChild?: boolean, children?: React.ReactNode } & React.RefAttributes<HTMLButtonElement>>}
 */
